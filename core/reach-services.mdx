...
<Tip>
  See the [`connect proxy`](/cli/proxy) command for complete proxy documentation.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Local Proxy" icon="globe" href="/cli/proxy">
  ...
  <Card title="Project Dev Mode" icon="folder" href="/cli/dev">
