---
title: Comparison and Migration from ngrok
description: Understanding the differences between ngrok and Private Connect, and how to migrate your workflows
---
...
<Steps>
  <Step title="Before: ngrok workflow">
    ```bash
    # Developer 1
    ngrok http 3000
    # Share URL in Slack...
  ...
  <Step title="After: Private Connect workflow">
    ```bash
    # Developer 1 (once)
    connect expose localhost:3000 --name my-api
...
<Steps>
  ...
  <Step title="Teammate clones your setup">
    ```bash
    connect clone you
    ```
  </Step>
  
  <Step title="They can now reach your services">
    ```bash
    connect reach my-api
    ```
  </Step>
