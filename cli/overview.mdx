...
- [`connect link`](/cli/link) - Create public URLs for services
...
### Utility Commands
- [`connect discover`](/cli/discover) - Scan for local services
- [`connect whoami`](/cli/whoami) - Display agent identity
- [`connect delete`](/cli/delete) - Delete a service
